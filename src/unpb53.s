...
;
.export unpb53_some, unpb53_tiles, unpb53_xtiles
.export PB53_outbuf
...
;;
; Unpacks tile data.
; @param ciBufStart starting offset into PB53_outbuf
; @param ciBufEnd ending offset into PB53_outbuf
; @param ciSrc start of uncompressed data
; Trashes $0000-$0001.
.proc unpb53_some
ctrlbyte = 0
bytesLeft = 1
...
;;
; Decompress PB53 compressed data to PPUDATA.
; @param ciSrc pointer to compressed tile data
; @param X decompressed data length in 16-byte units, or 0 for 4 KiB
; Trashes $0000-$0002.
.proc unpb53_xtiles
