...
def dedupe_chr(chrdata):
    """Find duplicate elements of an iterable.

Return a 2-tuple (unique_els, order) where unique_els is a list of
unique elements in the iterable, and (unique_els[i] for i in order)
reproduces the original iterable.
"""
    seen_chrdata = {}
    nt = []
    for tile in chrdata:
